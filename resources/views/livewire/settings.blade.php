            ...
            <div class="card bg-base-100 border border-base-300">
                <div class="card-body">
                    ...
                    <div class="form-control">
                        <label class="label"><span class="label-text text-xs font-bold uppercase tracking-wider text-base-content/50">Nombre de la Empresa</span></label>
                        <input type="text" wire:model="companyName" class="input input-bordered" placeholder="Barber CRM">
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-base-100 border border-base-300">
                <div class="card-body">
                    ...
                    <div class="form-control">
                        ...
                        <p class="text-xs text-base-content/50 mt-1">Si está activado, la app solicitará una contraseña al iniciar.</p>
                    </div>

                    <div x-data="{ show: @entangle('requirePassword') }" x-show="show" x-transition>
                        <div class="grid grid-cols-2 gap-3 mt-3">
                            <div class="form-control">
                                <label class="label"><span class="label-text text-xs font-bold uppercase tracking-wider text-base-content/50">Nueva Contraseña</span></label>
                                <input type="password" wire:model="appPassword" class="input input-bordered" placeholder="Dejar vacío para no cambiar">
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text text-xs font-bold uppercase tracking-wider text-base-content/50">Confirmar Contraseña</span></label>
                                <input type="password" wire:model="confirmPassword" class="input input-bordered" placeholder="Repetir contraseña">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card bg-base-100 border border-base-300">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="form-control">
                            <label class="label"><span class="label-text text-xs font-bold uppercase tracking-wider text-base-content/50">Hora de Apertura</span></label>
                            <input type="time" wire:model="openTime" class="input input-bordered">
                        </div>
                        <div class="form-control">
                            <label class="label"><span class="label-text text-xs font-bold uppercase tracking-wider text-base-content/50">Hora de Cierre</span></label>
                    ...
                    <div class="alert alert-info mt-3">
                        ...
                        <p class="text-xs">Los horarios de apertura y cierre afectan la disponibilidad en el calendario.</p>
                    </div>
                </div>
            </div>
